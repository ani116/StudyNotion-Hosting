...
const Instructor = () => {
    ...
    useEffect(() => {
        const getCourseDataWithStats = async() => {
            ...
            console.log("the instructor data is", instructorApiData)
    ...
    console.log("the instructor courses", courses)
    console.log("the instructor data", instructorData)
  ...
  return (
    <div>
      <div className="space-y-2">
        ...
        <p className="font-medium text-richblack-200">Let Start Something</p>
        {
            loading ? 
            ...
            courses.length > 0 ? (
                ...
                <div className="mt-20 rounded-md bg-richblack-800 p-6 py-20">
                    <p className="text-center text-2xl font-bold text-richblack-5">You Have not Create Any course Yet</p>
