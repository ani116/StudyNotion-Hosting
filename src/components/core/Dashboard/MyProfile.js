...
const MyProfile = () => {
    ...
    console.log("you are in my profile")
  ...
  return (
    <div>
        ...
        <h1 className='mb-14 text-3xl font-medium text-richblack-5'>Profile</h1>
        ...
        <div className="flex items-center justify-between rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-8 px-12">
            ...
            <button onClick={() => navigate("/dashboard/setting")} className='bg-yellow-300 rounded-md px-8 py-2'>
                Edit
            </button>
        </div>
